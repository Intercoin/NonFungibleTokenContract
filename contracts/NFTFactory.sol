...
contract NFTFactory is Ownable, CostManagerFactoryHelper, ReleaseManagerHelper {
    ...
    function produce(
        ...
        return _produce(name, symbol, contractURI, baseURI, suffixURI);
    }
    ...
    function _produce(
        ...
        require(
            instance != address(0),
            "StakingFactory: INSTANCE_CREATION_FAILED"
        );
    ...
    function _createInstance(
        ...
        _instanceInfos[instance] = InstanceInfo(name, symbol, _msgSender());
